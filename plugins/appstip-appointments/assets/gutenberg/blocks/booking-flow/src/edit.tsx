	...
	[
		...
		[
			[
				'core/button',
				{
					text: __('Back', 'appstip-appointments'),
			...
			[
				'core/button',
				{
					text: __('Book', 'appstip-appointments'),
...
export default function Edit({
	...
	return (
		<div {...blockProps}>
			<Suspense
				fallback={
					<div style={{ minHeight: 400, padding: 20 }}>
						{__('Loading booking flow…', 'appstip-appointments')}
					</div>
				}
			>
				<BookingFlow
			...
			<InspectorControls>
				<Panel>
					<PanelBody title={__('General', 'appstip-appointments')}>
						<SelectControl
							label={__('Flow type', 'appstip-appointments')}
					...
					<PanelBody title={__('Alignment', 'appstip-appointments')}>
						<ButtonGroup>
							<Button
								variant={
									alignment === 'Left'
								...
								label={__('Align left', 'appstip-appointments')}
							/>
							<Button
								variant={
									alignment === 'Center'
					...
					<PanelBody title={__('Size', 'appstip-appointments')}>
						<ButtonGroup>
							<Button
								variant={
