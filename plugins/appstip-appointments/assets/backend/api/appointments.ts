...
export function appointmentsApi({
	...
	async function updateAppointment(id: number, data: AppointmentData) {
		...
		if (error) {
			handleError(
				error,
				__('Cannot update appointment', 'appstip-appointments')
			);
			return;
		}
	...
	async function cancelAppointment(id: number) {
		...
		if (error) {
			handleError(
				error,
				__('Cannot cancel appointment', 'appstip-appointments')
			);
			return;
		}
	...
	async function deleteAppointment(id: number) {
		...
		if (error) {
			handleError(
				error,
				__('Cannot delete appointment', 'appstip-appointments')
			);
			return;
		}
	...
	async function confirmAppointment(id: number) {
		...
		if (error) {
			handleError(
				error,
				__('Cannot confirm appointment', 'appstip-appointments')
			);
			return;
		}
