...
export default function TimeSelector({
	...
	return (
		<SlideOut
			title={__('Select Time', 'appstip-appointments')}
			id="select-time"
		>
			<div className={styles.formGroup}>
				...
				>
					...
					>
						{__('Find time', 'appstip-appointments')}
					</Button>
				</FormFieldSet>

				<FormFieldSet
					legend={__('Select day', 'appstip-appointments')}
				...
				<div style={{ marginTop: '20px' }}>
					...
					>
						{available === '0'
							? __('Select time anyway', 'appstip-appointments')
