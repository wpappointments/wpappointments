	...
	return (
		<div>
			<FormFieldSet horizontal>
				<FormFieldSet
					horizontal
					legend={__('Start time', 'appstip-appointments')}
				>
					<FormField>
						<label
						...
						<SelectControl
							...
							hideLabelFromVision
							label={__('Hour', 'appstip-appointments')}
						/>
					</FormField>
					...
					<FormField>
						...
						>
							{__('Minute', 'appstip-appointments')}
						</label>
						<SelectControl
							id="timeMinuteStart"
							...
							size="__unstable-large"
							hideLabelFromVision
							label={__('Minute', 'appstip-appointments')}
						/>
					</FormField>
				</FormFieldSet>
				<FormFieldSet
					horizontal={true}
					legend={__('Duration', 'appstip-appointments')}
				>
					<FormField>
						<label
							className={formFieldStyles.fieldLabel}
							htmlFor="duration"
						>
							{__('Minutes', 'appstip-appointments')}
						</label>
						<NumberControl
							id="duration"
