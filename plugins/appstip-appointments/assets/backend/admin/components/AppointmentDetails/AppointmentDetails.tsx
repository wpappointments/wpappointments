...
export default function AppointmentDetails() {
	...
	return (
		<SlideOut
			title={__('Appointment', 'appstip-appointments')}
			id="view-appointment"
		>
			<div
				className={cn({
			...
			<div className={formStyles.formActions}>
				...
				{status === 'confirmed' && (
					...
					>
						{__('Cancel Appointment', 'appstip-appointments')}
					</Button>
				)}
				{status === 'cancelled' && (
					<Button
					...
					>
						{__('Delete Appointment', 'appstip-appointments')}
					</Button>
				)}
				{status === 'pending' && (
					<Button
					...
					>
						{__('Confirm Appointment', 'appstip-appointments')}
					</Button>
				)}
				{appointmentId > 0 && (
