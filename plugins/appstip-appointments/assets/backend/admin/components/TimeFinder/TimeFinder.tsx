...
export default function TimeFinder({
	...
	if (!month) {
		return <div>{__('Loading...', 'appstip-appointments')}</div>;
	}
	...
	return (
		<SlideOut
			title={__('Find time', 'appstip-appointments')}
			id={`find-time-${mode}`}
		>
			<div className={styles.header}>
				<div className={styles.buttons}>
					<ButtonGroup>
						...
						>
							{__('Early Morning', 'appstip-appointments')}
						</Button>
						<Button
							variant={
						...
						>
							{__('Morning', 'appstip-appointments')}
						</Button>
						<Button
							variant={
						...
						>
							{__('Afternoon', 'appstip-appointments')}
						</Button>
						<Button
							variant={
						...
						>
							{__('Evening', 'appstip-appointments')}
						</Button>
					</ButtonGroup>
				</div>
