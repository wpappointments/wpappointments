...
function getMonthName(month: number) {
	const months = [
		__('January', 'appstip-appointments'),
		__('February', 'appstip-appointments'),
		__('March', 'appstip-appointments'),
		__('April', 'appstip-appointments'),
		__('May', 'appstip-appointments'),
		__('June', 'appstip-appointments'),
		__('July', 'appstip-appointments'),
		__('August', 'appstip-appointments'),
		__('September', 'appstip-appointments'),
		__('October', 'appstip-appointments'),
		__('November', 'appstip-appointments'),
		__('December', 'appstip-appointments'),
	];
...
export default function Calendar() {
		...
		[
			<div className={styles.pagination}>
				<Button
					...
					aria-label={__('Previous month', 'appstip-appointments')}
				>
					&lsaquo;
				</Button>
				<Button
				...
				>
					{__('today', 'appstip-appointments')}
				</Button>
				<Button
					variant="secondary"
					size="compact"
					onClick={switchToNextMonth}
					aria-label={__('Next month', 'appstip-appointments')}
				>
					&rsaquo;
				</Button>
			</div>,
	...
	return (
		<StateContextProvider>
			<LayoutDefault
				title={__('Calendar', 'appstip-appointments')}
				fullWidth
			>
				<HeaderActionsFill>
					<Button
				...
				<div className={styles.topBar}>
					...
					<ButtonGroup className={styles.viewSwitcher}>
						...
						>
							{__('Week', 'appstip-appointments')}
						</Button>
						<Button variant="primary" size="compact">
							{__('Month', 'appstip-appointments')}
						</Button>
					</ButtonGroup>
				</div>
