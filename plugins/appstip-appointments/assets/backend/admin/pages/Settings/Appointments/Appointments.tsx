...
const LEAD_TIME_UNIT_OPTIONS = [
	{ label: __('Minutes', 'appstip-appointments'), value: 'minute' },
	{ label: __('Hours', 'appstip-appointments'), value: 'hour' },
	{ label: __('Days', 'appstip-appointments'), value: 'day' },
	{ label: __('Weeks', 'appstip-appointments'), value: 'week' },
	{ label: __('Months', 'appstip-appointments'), value: 'month' },
];
...
const fields: Field<Fields>[] = [
	{
		id: 'coreEntityName',
		type: 'text',
		label: __('Service Name', 'appstip-appointments'),
		placeholder: __('Appointment', 'appstip-appointments'),
		Edit: TextInput,
	},
	{
		id: 'defaultLength',
	...
	},
	{
		...
		type: 'integer',
		label: __('Time picker precision (in minutes)', 'appstip-appointments'),
	...
	},
	{
		id: 'minLeadTimeValue',
		type: 'integer',
		label: __('Minimum lead time', 'appstip-appointments'),
		isValid: { min: 0 },
		Edit: NumberInput,
	},
	{
		id: 'minLeadTimeUnit',
		label: __('Minimum lead time unit', 'appstip-appointments'),
	...
	},
	{
		id: 'maxLeadTimeValue',
		type: 'integer',
		label: __('Maximum lead time', 'appstip-appointments'),
		description: __('Leave at 0 for no limit.', 'appstip-appointments'),
		isValid: { min: 0 },
		Edit: NumberInput,
	},
	{
		id: 'maxLeadTimeUnit',
		label: __('Maximum lead time unit', 'appstip-appointments'),
		elements: LEAD_TIME_UNIT_OPTIONS,
		Edit: (props: DataFormControlProps<Fields>) => (
			<SelectInput {...props} labelInvisible />
		),
	...
	{
		id: 'defaultStatus',
		label: __('Default appointment status', 'appstip-appointments'),
		description: __(
		...
		elements: [
			{
				label: __('Confirmed', 'appstip-appointments'),
				value: 'confirmed',
			},
			{ label: __('Pending', 'appstip-appointments'), value: 'pending' },
		],
		Edit: SelectInput,
	},
];
...
export default function AppointmentsSettings() {
	...
	return (
		<Card className={globalStyles.card}>
			<CardHeader>
				<Text size="title">
					{__('Appointments Settings', 'appstip-appointments')}
				</Text>
			</CardHeader>
			<CardBody>
				<FormFieldSet>
