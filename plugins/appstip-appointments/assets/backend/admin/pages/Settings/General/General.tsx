...
const profileFields: Field<Fields>[] = [
	{
		id: 'firstName',
		type: 'text',
		label: __('First name', 'appstip-appointments'),
		Edit: TextInput,
	},
	{
		id: 'lastName',
		type: 'text',
		label: __('Last name', 'appstip-appointments'),
		Edit: TextInput,
	},
	{
		id: 'email',
		type: 'email',
		label: __('Email', 'appstip-appointments'),
		Edit: TextInput,
	},
	{
		id: 'phoneNumber',
		type: 'telephone',
		label: __('Phone number', 'appstip-appointments'),
		Edit: TextInput,
	},
	{
		id: 'companyName',
		type: 'text',
		label: __('Company name', 'appstip-appointments'),
		Edit: TextInput,
	},
];
...
const dateFormatFields: Field<Fields>[] = [
	{
		id: 'dateFormat',
		label: __('Date format', 'appstip-appointments'),
		elements: [
			{
...
const timeFormatFields: Field<Fields>[] = [
	{
		id: 'timeFormat',
		label: __('Time format', 'appstip-appointments'),
		elements: [
			{
...
export default function GeneralSettings() {
		...
		() => [
			{
				...
				elements: [
					{
						label: __('12 hours', 'appstip-appointments'),
						value: '12',
					},
					{
						label: __('24 hours', 'appstip-appointments'),
						value: '24',
					},
				],
				Edit: SelectInput,
			},
			{
				...
				type: 'boolean',
				label: __('Use site default timezone', 'appstip-appointments'),
				Edit: CheckboxInput,
			},
			{
				id: 'timezone',
	...
	return (
		<Card className={globalStyles.card}>
			<CardHeader>
				<Text size="title">
					{__('Profile and company details', 'appstip-appointments')}
				</Text>
			</CardHeader>
			<CardBody>
				<FormFieldSet>
			...
			<CardHeader style={{ borderTop: '1px solid #eee', marginTop: 15 }}>
				<Text size="title">
					{__('Calendar', 'appstip-appointments')}
				</Text>
			</CardHeader>
			<CardBody>
				<FormFieldSet>
			...
			<CardHeader style={{ borderTop: '1px solid #eee', marginTop: 15 }}>
				<Text size="title">
					{__('Date and time', 'appstip-appointments')}
				</Text>
			</CardHeader>
			<CardBody>
				...
				<FormFieldSet style={{ marginBottom: 25 }}>
					...
					<div>
						<small>
							{__('Universal time is', 'appstip-appointments')}{' '}
							<code>
								<small>
					...
					<div>
						<small>
							{__('Local time is', 'appstip-appointments')}{' '}
							<code>
								<small>
				...
				<FormFieldSet style={{ marginBottom: 25 }}>
					<div>
						...
						{formData.dateFormat &&
							...
							sprintf(
								__('Preview: %s', 'appstip-appointments'),
								format(
									new Date(),
									dateFormatMap.get(formData.dateFormat) ||
										'MMMM d, yyyy'
