...
const DAY_LABELS: Record<Day, string> = {
	monday: __('Monday', 'appstip-appointments'),
	tuesday: __('Tuesday', 'appstip-appointments'),
	wednesday: __('Wednesday', 'appstip-appointments'),
	thursday: __('Thursday', 'appstip-appointments'),
	friday: __('Friday', 'appstip-appointments'),
	saturday: __('Saturday', 'appstip-appointments'),
	sunday: __('Sunday', 'appstip-appointments'),
};
...
function CopyTimesButton({
	...
	return (
		<>
			<Tooltip text={__('Copy times to', 'appstip-appointments')}>
				<Button
					size="small"
					icon={copy}
					onClick={() => setIsOpen(!isOpen)}
					label={__('Copy times to', 'appstip-appointments')}
				/>
			</Tooltip>
			{isOpen && (
				<Popover
				...
				>
					<div className={styles.copyPopoverContent}>
						<div className={styles.copyPopoverHeader}>
							{__('COPY TIMES TO', 'appstip-appointments')}
						</div>
						<div className={styles.copyPopoverList}>
							<CheckboxControl
								__nextHasNoMarginBottom
								label={__('Select all', 'appstip-appointments')}
								checked={allSelected}
						...
						<div className={styles.copyPopoverFooter}>
							<Button variant="tertiary" onClick={handleCancel}>
								{__('Cancel', 'appstip-appointments')}
							</Button>
							<Button variant="primary" onClick={handleApply}>
								{__('Apply', 'appstip-appointments')}
							</Button>
						</div>
					</div>
				</Popover>
