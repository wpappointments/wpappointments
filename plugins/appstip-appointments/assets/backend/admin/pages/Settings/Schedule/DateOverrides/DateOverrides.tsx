		...
		<div className={styles.editorContent}>
			<div className={styles.calendarSection}>
				<p className={styles.sectionLabel}>
					{__('Select dates', 'appstip-appointments')}
				</p>
				<MultiDatePicker
			...
			{!isClosed && (
				<div className={styles.slotsSection}>
					<p className={styles.sectionLabel}>
						{__('Custom hours', 'appstip-appointments')}
					</p>
			...
			>
				{group
					? __('Update override', 'appstip-appointments')
					: __('Add override', 'appstip-appointments')}
			</Button>
		</div>
	);
}
...
export default function DateOverrides({
	...
	const openEditor = (group?: OverrideGroup) => {
		...
		openSlideOut({
			...
			title: group
				? __('Edit date override', 'appstip-appointments')
				: __('Add date override', 'appstip-appointments'),
			content: (
				<OverrideEditor
		...
		<div className={styles.dateOverrides}>
			<div className={styles.header}>
				<span className={styles.title}>
					{__('Date overrides', 'appstip-appointments')}
				</span>
				<Tooltip text={__('Add date override', 'appstip-appointments')}>
					<Button
						size="small"
						icon={plus}
						onClick={() => openEditor()}
						label={__('Add date override', 'appstip-appointments')}
					/>
				</Tooltip>
			</div>
			...
			{overrides.length === 0 && (
				<p className={styles.emptyState}>
					{__('No date overrides yet.', 'appstip-appointments')}
				</p>
			)}
				...
				return (
					...
					>
						<div className={styles.overrideInfo}>
							...
							>
								{isClosed
									? __('Unavailable', 'appstip-appointments')
									: group.slots
											.map((s) =>
