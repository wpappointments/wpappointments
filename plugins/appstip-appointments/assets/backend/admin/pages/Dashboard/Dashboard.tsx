...
export default function Dashboard() {
	...
	return (
		<StateContextProvider>
			<LayoutDefault title={__('Dashboard', 'appstip-appointments')}>
			...
			<CardHeader>
				<div className={styles.upcomingTitleWrapper}>
					<Text size="subheadline">
						{__('All Appointments', 'appstip-appointments')}
					</Text>
				</div>
				<Button
					variant="primary"
...
function UpcomingAppointments() {
	...
	return (
		<Card className={globalStyles.card}>
			<CardHeader>
				<Text size="subheadline">
					{__('Upcoming Appointments', 'appstip-appointments')}
				</Text>
			</CardHeader>
			<CardBody>
		...
		<Card className={globalStyles.card}>
			<CardHeader>
				<Text size="subheadline">
					...
					{sprintf(
						__('Hello %s!', 'appstip-appointments'),
						settings.firstName
					)}
				</Text>
