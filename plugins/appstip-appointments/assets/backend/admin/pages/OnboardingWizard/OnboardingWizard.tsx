		...
		<div className={styles.wizard}>
			...
			<div className={styles.wizardHeader}>
				...
				<Button variant="link" href={WIZARD_COMPLETE_URL}>
					{__('Skip guided setup', 'appstip-appointments')}
				</Button>
			</div>
...
function Welcome({ setCurrentStep }: StepProps) {
	return (
		<div className={styles.welcome}>
			...
			>
				{__('Set up appointments', 'appstip-appointments')}
			</Button>
		</div>
	);
}
...
function AllSet() {
	return (
		<div className={styles.welcome}>
			<div className={styles.stepHeader}>
				<h1 className={styles.title}>
					{__('All set!', 'appstip-appointments')}
				</h1>
				<p className={styles.leadText}>
					{__(
			...
			>
				{__('Go to dashboard', 'appstip-appointments')}
			</Button>
		</div>
	);
}
...
function OnboardingWizardStep1({ setCurrentStep }: StepProps) {
	return (
		<div style={{ margin: '40px auto' }}>
			<div className={styles.stepHeader}>
				<h1 className={styles.title}>
					{__('Tell us a bit about you', 'appstip-appointments')}
				</h1>
				<p className={styles.leadText}>
					{__(
...
function OnboardingWizardStep3({ setCurrentStep }: StepProps) {
	return (
		<div style={{ margin: '40px auto' }}>
			<div className={styles.stepHeader}>
				<h1 className={styles.title}>
					{__('Tailor you calendar options', 'appstip-appointments')}
				</h1>
				<p className={styles.leadText}>
					{__('You know what to do.', 'appstip-appointments')}
				</p>
			</div>
			<Calendar
				onSuccess={() => {
...
function OnboardingWizardStep4({ setCurrentStep }: StepProps) {
	return (
		<div style={{ margin: '40px auto' }}>
			<div className={styles.stepHeader}>
				<h1 className={styles.title}>
					{__('Setup you working hours', 'appstip-appointments')}
				</h1>
				<p className={styles.leadText}>
					{__(
...
function OnboardingWizardStep5({ setCurrentStep }: StepProps) {
	return (
		<div style={{ margin: '40px auto' }}>
			<div className={styles.stepHeader}>
				<h1 className={styles.title}>
					{__('Set up your services', 'appstip-appointments')}
				</h1>
				<p className={styles.leadText}>
					{__(
