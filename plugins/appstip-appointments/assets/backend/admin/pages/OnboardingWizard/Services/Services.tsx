...
const fields: Field<ServiceFormData>[] = [
	{
		...
		placeholder: __('e.g. Consultation', 'appstip-appointments'),
	...
	},
	{
		id: 'duration',
		type: 'integer',
		label: __('Duration (minutes)', 'appstip-appointments'),
...
function AddServiceForm({
	...
	return (
		...
		>
			...
			>
				{__('Add Service', 'appstip-appointments')}
			</Button>
		</form>
	);
}
		...
		<div>
			{services.length > 0 && (
				...
				>
					<thead>
						<tr>
							<th>{__('Name', 'appstip-appointments')}</th>
							<th style={{ width: 120 }}>
								{__('Duration (min)', 'appstip-appointments')}
							</th>
							<th style={{ width: 80 }}>
								{__('Remove', 'appstip-appointments')}
							</th>
						</tr>
					</thead>
					<tbody>
