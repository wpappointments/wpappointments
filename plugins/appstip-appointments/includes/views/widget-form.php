...
<?php esc_html_e( 'Title:', 'appstip-appointments' ); ?>
</label>
<input
	class="widefat"
...
<?php esc_html_e( 'Flow type:', 'appstip-appointments' ); ?>
</label>
<select
	class="widefat"
...
<?php esc_html_e( 'One Step', 'appstip-appointments' ); ?>
	</option>
	<option value="multi_step" <?php selected( $flow_type, 'multi_step' ); ?>>
<?php esc_html_e( 'Multi Step', 'appstip-appointments' ); ?>
	</option>
</select>
</p>
<p>
<label for="<?php echo esc_attr( $widget->get_field_id( 'alignment' ) ); ?>">
<?php esc_html_e( 'Alignment:', 'appstip-appointments' ); ?>
</label>
<select
	class="widefat"
...
<?php esc_html_e( 'Left', 'appstip-appointments' ); ?>
	</option>
	<option value="center" <?php selected( $alignment, 'center' ); ?>>
<?php esc_html_e( 'Center', 'appstip-appointments' ); ?>
	</option>
	<option value="right" <?php selected( $alignment, 'right' ); ?>>
<?php esc_html_e( 'Right', 'appstip-appointments' ); ?>
	</option>
</select>
</p>
<p>
<label for="<?php echo esc_attr( $widget->get_field_id( 'width' ) ); ?>">
<?php esc_html_e( 'Width:', 'appstip-appointments' ); ?>
</label>
<select
	class="widefat"
...
<?php esc_html_e( 'Narrow', 'appstip-appointments' ); ?>
	</option>
	<option value="full" <?php selected( $width, 'full' ); ?>>
<?php esc_html_e( 'Full', 'appstip-appointments' ); ?>
	</option>
</select>
</p>
<p>
...
<?php esc_html_e( 'Trim unavailable slots', 'appstip-appointments' ); ?>
</label>
</p>
<p>
<input
...
<?php esc_html_e( 'Show time slots as buttons', 'appstip-appointments' ); ?>
</label>
</p>
