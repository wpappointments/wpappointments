...
class Settings {
	...
	public function update( $category, $settings = array() ) {
		...
		if ( ! $category_exists ) {
			return new \WP_Error( 'invalid_settings_category', __( 'Invalid settings category', 'appstip-appointments' ) );
		}
		...
		return new \WP_Error( 'unknown_settings_error', __( 'Unknown error while saving settings', 'appstip-appointments' ) );
	}
