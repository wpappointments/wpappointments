...
class CustomersController extends Controller {
	...
	public static function get_all( WP_REST_Request $request ) {
		...
		return self::response(
			__( 'Customers fetched successfully', 'appstip-appointments' ),
	...
	public static function create( WP_REST_Request $request ) {
		...
		return self::response(
			__( 'Customer created successfully', 'appstip-appointments' ),
			array(
	...
	public static function update( WP_REST_Request $request ) {
		...
		return self::response(
			__( 'Customer updated successfully', 'appstip-appointments' ),
			array(
	...
	public static function delete( WP_REST_Request $request ) {
		...
		return self::response(
			__( 'Customer deleted successfully', 'appstip-appointments' ),
			array(
				'id' => $deleted,
			),
		);
