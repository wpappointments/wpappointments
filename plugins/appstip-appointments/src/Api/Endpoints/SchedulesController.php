...
class SchedulesController extends Controller {
	...
	public static function get_all_schedules( $request ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.Found -- Required by REST callback contract.
		...
		return self::response(
			__( 'Schedules fetched successfully', 'appstip-appointments' ),
	...
	public static function create_schedule( $request ) {
		...
		if ( empty( $data['name'] ) ) {
			return self::error(
				new WP_Error( 'schedule_name_required', __( 'Schedule name is required', 'appstip-appointments' ), array( 'status' => 422 ) )
			);
		}
		...
		return self::response(
			__( 'Schedule created successfully', 'appstip-appointments' ),
	...
	public static function get_schedule( $request ) {
		...
		return self::response(
			__( 'Schedule fetched successfully', 'appstip-appointments' ),
	...
	public static function update_schedule( $request ) {
		...
		return self::response(
			__( 'Schedule updated successfully', 'appstip-appointments' ),
	...
	public static function delete_schedule( $request ) {
		...
		return self::response(
			__( 'Schedule deleted successfully', 'appstip-appointments' ),
			array( 'id' => $deleted )
		);
	}
	...
	public static function set_default( $request ) {
		...
		if ( ! $active ) {
			return self::error(
				new WP_Error( 'schedule_inactive', __( 'Cannot set an inactive schedule as default', 'appstip-appointments' ), array( 'status' => 422 ) )
			);
		}
		...
		return self::response(
			__( 'Default schedule updated', 'appstip-appointments' ),
			array( 'schedule' => $model->normalize() )
		);
	}
