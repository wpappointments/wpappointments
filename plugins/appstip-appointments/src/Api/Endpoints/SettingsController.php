...
class SettingsController extends Controller {
	...
	public static function get_all_settings() {
		...
		return self::response(
			__( 'Settings fetched successfully', 'appstip-appointments' ),
			array(
				'settings' => $settings,
			),
		);
	...
	public static function get_category_settings( WP_REST_Request $request ) {
		...
		return self::response(
			__( 'Settings in category fetched successfully', 'appstip-appointments' ),
			array(
				'settings' => $settings,
			),
		);
	...
	public static function update_settings( WP_REST_Request $request ) {
		...
		return self::response(
			__( 'Settings updated successfully', 'appstip-appointments' ),
			array(
				'settings' => $settings,
			),
		);
