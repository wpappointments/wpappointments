...
class VariantsController extends Controller {
	...
	public static function get_variants( $request ) {
		...
		return self::response(
			__( 'Variants fetched successfully', 'appstip-appointments' ),
	...
	public static function create_variant( $request ) {
		...
		return self::response(
			__( 'Variant created successfully', 'appstip-appointments' ),
	...
	public static function generate_variants( $request ) {
		...
		return self::response(
			__( 'Variants generated successfully', 'appstip-appointments' ),
	...
	public static function get_variant( $request ) {
		...
		if ( $model->variant->post_parent !== $entity_id ) {
			return self::error(
				new WP_Error(
					'rest_invalid_parent',
					__( 'Variant does not belong to the specified bookable entity', 'appstip-appointments' ),
					array( 'status' => 404 )
				)
			);
		}
		...
		return self::response(
			__( 'Variant fetched successfully', 'appstip-appointments' ),
	...
	public static function update_variant( $request ) {
		...
		return self::response(
			__( 'Variant updated successfully', 'appstip-appointments' ),
	...
	public static function delete_variant( $request ) {
		...
		return self::response(
			__( 'Variant deleted successfully', 'appstip-appointments' ),
			array( 'id' => $deleted )
		);
	}
