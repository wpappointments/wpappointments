...
class BookablesController extends Controller {
	...
	public static function get_all_bookables( $request ) {
		...
		return self::response(
			__( 'Bookables fetched successfully', 'appstip-appointments' ),
	...
	public static function create_bookable( $request ) {
		...
		if ( empty( $data['name'] ) ) {
			return self::error(
				new WP_Error( 'bookable_name_required', __( 'Bookable name is required', 'appstip-appointments' ), array( 'status' => 422 ) )
			);
		}
		...
		return self::response(
			__( 'Bookable created successfully', 'appstip-appointments' ),
	...
	public static function get_bookable( $request ) {
		...
		return self::response(
			__( 'Bookable fetched successfully', 'appstip-appointments' ),
	...
	public static function update_bookable( $request ) {
		...
		return self::response(
			__( 'Bookable updated successfully', 'appstip-appointments' ),
	...
	public static function delete_bookable( $request ) {
		...
		return self::response(
			__( 'Bookable deleted successfully', 'appstip-appointments' ),
			array( 'id' => $deleted )
		);
	}
