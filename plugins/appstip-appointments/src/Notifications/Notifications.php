		...
		if ( null === self::$events ) {
			$events = array(
				'created'   => array(
					...
					'adminSubject'    => __( 'New appointment booked', 'appstip-appointments' ),
					'customerSubject' => __( 'Your appointment has been booked', 'appstip-appointments' ),
				...
				'updated'   => array(
					...
					'description'     => __( 'Sent when an existing appointment is modified.', 'appstip-appointments' ),
					'adminSubject'    => __( 'Appointment updated', 'appstip-appointments' ),
					'customerSubject' => __( 'Your appointment has been updated', 'appstip-appointments' ),
				...
				'confirmed' => array(
					...
					'description'     => __( 'Sent when an appointment is confirmed.', 'appstip-appointments' ),
					'adminSubject'    => __( 'Appointment confirmed', 'appstip-appointments' ),
					'customerSubject' => __( 'Your appointment is confirmed', 'appstip-appointments' ),
				...
				'cancelled' => array(
					...
					'description'     => __( 'Sent when an appointment is cancelled.', 'appstip-appointments' ),
					'adminSubject'    => __( 'Appointment cancelled', 'appstip-appointments' ),
					'customerSubject' => __( 'Your appointment has been cancelled', 'appstip-appointments' ),
