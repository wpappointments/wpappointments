...
class PostTypes {
	...
	private static function register_appointment_post_type() {
		register_post_type(
			...
			array(
				'label'               => __( 'Appointments', 'appstip-appointments' ),
				'public'              => false,
				'show_ui'             => true,
				'show_in_menu'        => false,
				'show_in_rest'        => true,
	...
	private static function register_schedule_post_type() {
		register_post_type(
			...
			array(
				'label'               => __( 'Schedules', 'appstip-appointments' ),
				'public'              => false,
				'show_ui'             => true,
				'show_in_menu'        => false,
				'show_in_rest'        => true,
	...
	private static function register_bookable_post_type() {
		register_post_type(
			...
			array(
				'label'               => __( 'Bookables', 'appstip-appointments' ),
				'public'              => false,
				'show_ui'             => true,
				'show_in_menu'        => false,
				'show_in_rest'        => true,
	...
	private static function register_bookable_variant_post_type() {
		register_post_type(
			...
			array(
				'label'               => __( 'Bookable Variants', 'appstip-appointments' ),
				'public'              => false,
				'show_ui'             => true,
				'show_in_menu'        => false,
				'show_in_rest'        => true,
	...
	private static function register_ooo_post_type() {
		register_post_type(
			...
			array(
				'label'               => __( 'Out of Office', 'appstip-appointments' ),
				'public'              => false,
				'show_ui'             => false,
				'show_in_menu'        => false,
				'show_in_rest'        => false,
