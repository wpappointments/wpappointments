...
description: How to build addons for Appointments Booking.
---

Appointments Booking is designed to be extended through WordPress plugins that hook into its registries and APIs.
...
A Appointments Booking addon is a standard WordPress plugin that depends on the core plugin:
